...
class ThreeJS extends Component {
  componentDidMount() {
    ...
    var geometry = new THREE.BoxGeometry(1, 1, 1); // changes the height, width, and length of the 3D object
    var material = new THREE.MeshBasicMaterial({ color: 0x00ff00 }); // changes the color the 0x means #
